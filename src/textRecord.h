...
static void processTextLine(std::string line,Disassembler *disassembler){
    ...
    if(line.compare(0,1,"T") == 0){
        ...
        std::string objCodeLine(line,9,textLineSize);       // Trim the object code line
